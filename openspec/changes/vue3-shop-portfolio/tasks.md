...
- [x] 8.1 建立 `src/views/ProductDetailView.vue`
- [x] 8.2 從路由 params 取得 id，呼叫 API 取得商品資料
- [x] 8.3 顯示完整商品資訊
- [x] 8.4 實作數量選擇與「加入購物車」按鈕
- [x] 8.5 商品不存在時導回首頁

## 9. 購物車頁

- [x] 9.1 建立 `src/views/CartView.vue`
- [x] 9.2 顯示購物車商品清單、小計、總金額
- [x] 9.3 實作數量增減按鈕
- [x] 9.4 實作移除商品按鈕
- [x] 9.5 購物車為空時顯示提示與返回連結
- [x] 9.6 「前往結帳」按鈕導向訂單確認頁

## 10. 訂單確認頁

- [x] 10.1 建立 `src/views/OrderView.vue`
- [x] 10.2 購物車為空時導回購物車頁（navigation guard）
- [x] 10.3 顯示訂單摘要（商品、數量、總金額）
- [x] 10.4 「確認送出」清空購物車並顯示成功訊息
